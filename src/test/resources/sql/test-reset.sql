...
TRUNCATE TABLE submission_detail;
...
INSERT INTO user_info (id, username, email, password, is_del)
VALUES (10001, 'admin_user', 'admin@test.local',
        '$2a$10$JOD0yzajuN.zC5a2mUaw6uq05DHOeDka9VFM4UWj4xodHAtlvE1O.', 0),
       (10002, 'normal_user', 'user@test.local',
        '$2a$10$JOD0yzajuN.zC5a2mUaw6uq05DHOeDka9VFM4UWj4xodHAtlvE1O.', 0),
       (10003, 'teacher_user', 'teacher@test.local',
        '$2a$10$JOD0yzajuN.zC5a2mUaw6uq05DHOeDka9VFM4UWj4xodHAtlvE1O.', 0),
       (10004, 'second_user', 'second@test.local',
        '$2a$10$JOD0yzajuN.zC5a2mUaw6uq05DHOeDka9VFM4UWj4xodHAtlvE1O.', 0);
...
VALUES (20001, 'PPUBLIC', 'Public Problem', 0, 0, 1, 0),
       (20002, 'PPRIVATE', 'Private Problem', 0, 0, 0, 0);

INSERT INTO contest (id, title, subtitle, description, start_time, end_time, rule_type, is_public, is_del)
VALUES (30001, 'Linked Contest', 'it', 'for delete conflict',
...
VALUES (40001, 'Linked ProblemSet', 'for delete conflict', 10001, 1, 0);
